    ...
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="text-center">
          ...
          <div>
            <span class="d-block mt-3">Dear <?php echo e($user['name']); ?>, <br><br> <?php echo e($otp); ?> is your one time password (OTP) for forgot password OTP. Please do not share the OTP with others.</span>
          </div>
          <div class="footer">
...
<?php /**PATH C:\xampp\htdocs\mmm\storage\framework\views/aea3c508f733d208bf826e56af4c858b.blade.php ENDPATH**/ ?>