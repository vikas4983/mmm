<?php
    $selectedCastes = explode(',',$advanceFilter['caste']) ?? [];
    $selectedStates = explode(',',$advanceFilter['state']) ?? [];
    $selectedcities = explode(',',$advanceFilter['city']) ?? [];
?>

<?php if($action === 'advanceCasteCriteria'): ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<?php if($action === 'advanceStateCriteria'): ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<?php if($action === 'advanceCityCriteria'): ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH C:\xampp\htdocs\mmm\resources\views/ajaxOptions/filterCriterias/advanceFilterCriteria.blade.php ENDPATH**/ ?>