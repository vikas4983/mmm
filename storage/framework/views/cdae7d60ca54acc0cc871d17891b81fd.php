                ...
                <div class="container" id="container"> <!-- Added ID for targeting -->
                    <div class="row">
                        ...
                        <div class="col-xxl-6 col-xs-16 col-xl-6 col-xs-offset-0 col-xxl-offset-5 col-sm-offset-0 col-md-offset-0 col-xl-offset-5 col-lg-10 col-lg-offset-3">
                            <form class="gt-login-form gtLogin" action="<?php echo e(route('forgot.password.otp')); ?>" method="post" id="forgot_form">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mmm\resources\views\forgotPassword.blade.php ENDPATH**/ ?>