...
<?php $__env->startSection('title', 'Lifestyle Details'); ?>
        ...
        <div class="container">
            ...
            <div class="gtRegister col-xxl-11">
                ...
                <h3 class="gt-text-green mb-10 fontMerriWeather">
                    <i class="fa fa-user mr-10"></i>Lifestyle Details
                </h3>
                <article>
                ...
                <form action="<?php echo e(route('lifestyleDetails.store')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <?php
...
<?php echo $__env->make('layouts.frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mmm\resources\views\frontend\registration\lifestyleDetails\create.blade.php ENDPATH**/ ?>