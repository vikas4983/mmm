                    ...
                    <div class="gt-panel gt-panel-orange inHomeLeftPanel">
                        ...
                        <div class="gt-left-pan-option">
                            <div class="row">
                                ...
                                <a href="<?php echo e(route('my.shortlist')); ?>" class="col-xxl-16 col-xl-16 col-xs-16 ripplelink">
                                    <div class="row">
                                        <div class="col-xxl-13 col-xl-12 col-xs-13">
                                ...
                                <a href="<?php echo e(route('block.by.me')); ?>" class="col-xxl-16 col-xl-16 col-xs-16 ripplelink">
                                    <div class="row">
                                        <div class="col-xxl-13 col-xl-12 col-xs-13">
                                ...
                                <a href="<?php echo e(route('view.profile.by.other')); ?>" class="col-xxl-16 col-xl-16 col-xs-16 ripplelink">
                                    <div class="row">
                                        <div class="col-xxl-13 col-xl-12 col-xs-13">
                                ...
                                <a href="<?php echo e(route('view.profile')); ?>" class="col-xxl-16 col-xl-16 col-xs-16 ripplelink">
                                    <div class="row">
                                        <div class="col-xxl-13 col-xl-12 col-xs-13">
                                ...
                                <a href="<?php echo e(route('view.contact.by.me')); ?>" class="col-xxl-16 col-xl-16 col-xs-16 ripplelink">
                                    <div class="row">
                                        <div class="col-xxl-13 col-xl-12 col-xs-13">
                                        ...
                                        <?php $__currentLoopData = $user->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($image->dp_image === '1'): ?>
                                                ...
                                                <a href="#editPhoto1Modal" data-toggle="modal"
                                                    data-info="<?php echo e($image->id); ?>" class="btn gt-btn-green btn-block">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?php echo e(route('change.profile.image')); ?>" method="post"
        ...
        <div class="modal fade" id="addPhoto1Modal" tabindex="-1" role="dialog" aria-labelledby="addPhoto1Modal"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo e(route('add.image')); ?>" method="post" enctype="multipart/form-data"
...
<?php echo $__env->make('layouts.frontend.main-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mmm\resources\views/frontend/users/photo.blade.php ENDPATH**/ ?>