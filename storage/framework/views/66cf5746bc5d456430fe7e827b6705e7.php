...
<div class="container mt-20 ">
    <div class="row">
                            ...
                            <div class="col-xs-16" bis_skin_checked="1">
                                <label for="photo">
                                    <input type="checkbox"
                                        ...
                                        id="photo" name="photo[]" value="0" <?php echo e(in_array(0, old('photo', $validatedData['photo'] ?? ['0'])) ? 'checked' : ''); ?>>
                                    <span style="margin-left: 10px">All</span>
                                </label>
                            </div>
                            <div class="col-xs-16" bis_skin_checked="1">
                                <label for="photo">
                                    <input type="checkbox" class="photo-checkbox gt-margin-left-10 gt-cursor name"
                                        id="photo" name="photo[]" value="1" <?php echo e(in_array(1, old('photo', $validatedData['photo'] ?? [])) ? 'checked' : ''); ?>>
            ...
            <div class="gt-panel-body max-height-200" id="left-panel-7" bis_skin_checked="1">
                <div class="row" bis_skin_checked="1">
                    <div class="list" bis_skin_checked="1">
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="join_at">
                                <input type="checkbox" class="join_at-checkbox  gt-margin-left-10 gt-cursor name"
                                    id="join_at" name="join_at[]" value="0" <?php echo e(in_array(0, old('join_at', $validatedData['join_at'] ?? ['0'])) ? 'checked' : ''); ?>>
                                <span style="margin-left: 10px">All</span>
                            </label>
                        </div>
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="join_at">
                                <input type="checkbox" class="join_at-checkbox gt-margin-left-10 gt-cursor name"
                                    id="join_at" name="join_at[]" value="day" <?php echo e(in_array('day', old('join_at', $validatedData['join_at'] ?? [''])) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="join_at">
                                <input type="checkbox" class="join_at-checkbox gt-margin-left-10 gt-cursor name"
                                    id="join_at" name="join_at[]" value="week" <?php echo e(in_array('week', old('join_at', $validatedData['join_at'] ?? [''])) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="join_at">
                                <input type="checkbox" class="join_at-checkbox gt-margin-left-10 gt-cursor name"
                                    id="join_at" name="join_at[]" value="month" <?php echo e(in_array('month', old('join_at', $validatedData['join_at'] ?? [''])) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="religion">
                                <input type="checkbox"
                                    ...
                                    id="religion" name="religion[]" value="0" <?php echo e(in_array(0, old('religion', $validatedData['religion'] ?? ['0'])) ? 'checked' : ''); ?>>
                                <span style="margin-left: 10px">All</span>
                            </label>
                        </div>
                        ...
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="religion">
                                <input type="checkbox"
                                    ...
                                    id="religion" name="religion[]" value="<?php echo e($religion->id); ?>"
                                    <?php echo e(in_array($religion->id, old('religion', $validatedData['religion'] ?? [])) ? 'checked' : ''); ?>>

                                <span style="margin-left: 10px"><?php echo e($religion->name ?? ''); ?></span>
                            </label>
                        </div>
        ...
        <div class="gt-panel gt-panel-default " bis_skin_checked="1" id="whole-caste-div">
            <div class="gt-panel-head" bis_skin_checked="1">
                <div class="row" bis_skin_checked="1">
                    <div class="col-xs-12" bis_skin_checked="1" style="display: flex; align-items: center;">
                        <b style="display: flex; align-items: center;">
                            Castes
                            <span id="loader" class="data-load-loader" style="display: none;">
                                <?php if (isset($component)) {
                                    $__componentOriginal1ecadc6d68688358e6e0de216be4e673 = $component;
                                } ?>
                                <?php if (isset($attributes)) {
                                    $__attributesOriginal1ecadc6d68688358e6e0de216be4e673 = $attributes;
                                } ?>
                            ...
                            <div class="col-xs-16" bis_skin_checked="1">
                                <label for="caste">
                                    <input type="checkbox"
                                        ...
                                        id="caste" name="caste[]" value="0" <?php echo e(in_array(0, old('caste', $validatedData['caste'] ?? [])) ? 'checked' : ''); ?>>
                                    <span style="margin-left: 10px">All</span>
                                </label>
                            </div>
                    ...
                    <div class="list" bis_skin_checked="1">
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="marital_status">
                                <input type="checkbox"
                                    ...
                                    id="marital_status" name="marital_status[]" value="0" <?php echo e(in_array(0, old('marital_status', $validatedData['marital_status'] ?? ['0'])) ? 'checked' : ''); ?>>
                                <span style="margin-left: 10px">All</span>
                            </label>
                        </div>
                        ...
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="marital_status">
                                <input type="checkbox"
                                    class="marital-status-checkbox gt-margin-left-10 gt-cursor name"
                                    id="marital_status" name="marital_status[]" value="<?php echo e($maritalStatus->id); ?>"
                                    <?php echo e(in_array($maritalStatus->id, old('marital_status', $validatedData['marital_status'] ?? [])) ? 'checked' : ''); ?>>
                                <span style="margin-left: 10px"><?php echo e($maritalStatus->name ?? ''); ?></span>
                            </label>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
            ...
            <div class="gt-panel-body max-height-200" id="left-panel-5" bis_skin_checked="1">
                <div class="row" id="education" bis_skin_checked="1">
                    ...
                    <div class="list" bis_skin_checked="1">
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="education">
                                <input type="checkbox" class="education-checkbox gt-margin-left-10 gt-cursor name"
                                    id="education" name="education[]" value="0" <?php echo e(in_array(0, old('education', $validatedData['education'] ?? ['0'])) ? 'checked' : ''); ?>>
                                <span style="margin-left: 10px">All</span>
                            </label>
                        </div>
                        ...
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="education">
                                <input type="checkbox" class="education-checkbox gt-margin-left-10 gt-cursor name"
                                    id="education" name="education[]" value="<?php echo e($education->id); ?>"
                                    <?php echo e(in_array($education->id, old('education', $validatedData['education'] ?? [])) ? 'checked' : ''); ?> class="gt-cursor">
                                <span style="margin-left: 10px"><?php echo e($education->education); ?>-<?php echo e($education->id); ?></span>
                            </label>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="gt-panel-body max-height-200" id="left-panel-5" bis_skin_checked="1">
                <div class="row" id="employee" bis_skin_checked="1">
                    ...
                    <div class="list" bis_skin_checked="1">
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="employee">
                                <input type="checkbox" class="employee-checkbox gt-margin-left-10 gt-cursor name"
                                    id="employee" name="employee[]" value="0" <?php echo e(in_array(0, old('employee', $validatedData['employee'] ?? ['0'])) ? 'checked' : ''); ?>>
                                <span style="margin-left: 10px">All</span>
                            </label>
                        </div>
                        ...
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="employee">
                                <input type="checkbox" class="employee-checkbox gt-margin-left-10 gt-cursor name"
                                    id="employee" name="employee[]" value="<?php echo e($employee->id); ?>"
                                    <?php echo e(in_array($employee->id, old('employee', $validatedData['employee'] ?? [])) ? 'checked' : ''); ?>>
                                <span style="margin-left: 10px"><?php echo e($employee->employee); ?></span>
                            </label>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="list" bis_skin_checked="1">
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="occupation">
                                <input type="checkbox" class="occupation-checkbox gt-margin-left-10 gt-cursor name"
                                    id="occupation" name="occupation[]" value="0" <?php echo e(in_array(0, old('occupation', $validatedData['occupation'] ?? ['0'])) ? 'checked' : ''); ?>>
                                <span style="margin-left: 10px">All</span>
                            </label>
                        </div>
                        ...
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="occupation">
                                <input type="checkbox"
                                    ...
                                    id="occupation" name="occupation[]" value="<?php echo e($occupation->id); ?>"
                                    <?php echo e(in_array($occupation->id, old('occupation', $validatedData['occupation'] ?? [])) ? 'checked' : ''); ?>>
                                <span style="margin-left: 10px"><?php echo e($occupation->occupation); ?>-<?php echo e($occupation->id); ?></span>
                            </label>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
            ...
            <div class="gt-panel-body max-height-200" id="left-panel-5" bis_skin_checked="1">
                <div class="row" id="income" bis_skin_checked="1">
                    ...
                    <div class="list" bis_skin_checked="1">
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="income">
                                <input type="checkbox" class="income-checkbox gt-margin-left-10 gt-cursor name"
                                    id="income" name="income[]" value="0" <?php echo e(in_array(0, old('income', $validatedData['income'] ?? ['0'])) ? 'checked' : ''); ?>>
                                <span style="margin-left: 10px">All</span>
                            </label>
                        </div>
                        ...
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="income">
                                <input type="checkbox" class="income-checkbox gt-margin-left-10 gt-cursor name"
                                    id="income" name="income[]" value="<?php echo e($income->id); ?>" <?php echo e(in_array($income->id, old('income', $validatedData['income'] ?? [])) ? 'checked' : ''); ?>>
                                <span style="margin-left: 10px"><?php echo e($income->income); ?>-<?php echo e($income->id); ?></span>
                            </label>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="gt-panel gt-panel-default" bis_skin_checked="1">
            <div class="gt-panel-head" bis_skin_checked="1">
                <div class="row" bis_skin_checked="1">
                    ...
                    <div class="col-xs-4" bis_skin_checked="1">
                        <div class="row" bis_skin_checked="1">
                            <a onclick="return clearcountry();" class="gt-cursor"> <i class="fa fa-times-circle"></i>
                                Clear </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="gt-panel-body max-height-200" bis_skin_checked="1">
                <div class="row" id="users" bis_skin_checked="1">
                    ...
                    <div class="list" bis_skin_checked="1">
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="diet-all">
                                <input type="checkbox" class="diet-checkbox all-diet gt-margin-left-10 gt-cursor name"
                        ...
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="diet">
                                <input type="checkbox" id="diet" value="<?php echo e($diet->id); ?>" name="diet[]"
                                    class="diet-checkbox "> <span class="gt-margin-left-10 gt-cursor name"
                    ...
                    <div class="list" bis_skin_checked="1">
                        ...
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="physical_status">
                                <input type="checkbox" id="physical_status" value="<?php echo e($physicalStatus->id); ?>"
                                    name="physical_status[]" class="physical-status-checkbox "> <span
                                    class="gt-margin-left-10 gt-cursor name" <?php echo e(in_array($physicalStatus->id, old('physical_status', $validatedData['physical_status'] ?? [])) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="country-all">
                                <input type="checkbox"
                                    ...
                                    id="country-all" name="country[]" value="0" <?php echo e(in_array(0, old('country', $validatedData['country'] ?? ['0'])) ? 'checked' : ''); ?>>
                                &nbsp;&nbsp;&nbsp;
                                <span>All</span>
                            </label>
                        </div>
                        ...
                        <div class="col-xs-16" bis_skin_checked="1">
                            <label for="country-<?php echo e($country->id); ?>">
                                <input type="checkbox" id="country-<?php echo e($country->id); ?>"
                                    value="<?php echo e($country->id); ?>" name="country[]" class="country-checkbox countrycb"
                                    <?php echo e(in_array($country->id, old('country', $validatedData['country'] ?? [])) ? 'checked' : ''); ?>>
                                <span class="gt-margin-left-10 gt-cursor name"><?php echo e($country->country); ?></span>
                            </label>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
        ...
        <div class="gt-panel gt-panel-default" id="state-div">
            ...
            <div class="gt-panel-body max-height-200">
                <div class="row" id="users">
                    ...
                    <div class="col-xs-16">
                        <label for="state-all">
                            <input type="checkbox" class="statecb state-checkbox gt-margin-left-10 gt-cursor name"
                                id="state-all" name="state[]" value="0" <?php echo e(in_array(0, old('state', $validatedData['state'] ?? ['0'])) ? 'checked' : ''); ?>>
                            &nbsp;&nbsp;&nbsp;<span>All</span>
                        </label>
                    </div>
                        ...
                        <div class="list">
                            ...
                            <div class="col-xs-16">
                                <label for="state-<?php echo e($state->id); ?>">
                                    <input type="checkbox" id="state" value="<?php echo e($state->id); ?>"
                                        name="state[]" class="state-checkbox statecb" <?php echo e(in_array($state->id, old('state', $validatedData['state'] ?? [])) ? 'checked' : ''); ?>>
        ...
        <div class="gt-panel gt-panel-default" id="city-div">
            ...
            <div class="gt-panel-body max-height-200">
                <div class="row" id="users">
                    ...
                    <div class="col-xs-16">
                        <label for="city-all">
                            <input type="checkbox" class="city city-filter gt-margin-left-10 gt-cursor name"
                                id="city-all" name="city[]" value="0" <?php echo e(in_array(0, old('city', $validatedData['city'] ?? [])) ? 'checked' : ''); ?>>
                            &nbsp;&nbsp;&nbsp;<span>All</span>
                        </label>
                    </div>
                    <div id="city-list">
...
<div class="col-xxl-12 col-xl-12 col-xs-16 gt-search-result" id="result" bis_skin_checked="1">
    ...
    <ul id="pagination">
                ...
                <div class="col-xxl-16 col-xs-16" bis_skin_checked="1">
                    ...
                    <p>
                        <span style="color:red;">
                            <b class="result-count"><?php echo e($searchResults->count() ?? ''); ?></b>
                        </span> Profiles found :
        ...
        <div id="waveLoader" style="display: none">
            <?php if (isset($component)) {
                $__componentOriginal1d03a612b9d775483b4d1aff66b6aca0 = $component;
            } ?>
            <?php if (isset($attributes)) {
                $__attributesOriginal1d03a612b9d775483b4d1aff66b6aca0 = $attributes;
            } ?>
        ...
        <div class="filter-profile">
            <?php if (isset($component)) {
                $__componentOriginalf23dcddf411442c3128d2d01b57e9509 = $component;
            } ?>
            <?php if (isset($attributes)) {
                $__attributesOriginalf23dcddf411442c3128d2d01b57e9509 = $attributes;
            } ?>
        ...
        <div class="modal fade-in" id="myModal6" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            aria-hidden="true" bis_skin_checked="1"></div>
        <div class="modal fade-in" id="myModal7" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            aria-hidden="true" bis_skin_checked="1"></div>
