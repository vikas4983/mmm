            ...
            <div id="main">
                <div class="container">
                    <div class="gtMobileVerification col-xxl-10 col-xxl-offset-3 col-xs-16 col-xs-offset-0">
                        ...
                        <h2 class="inPageTitle fontMerriWeather text-center mt-15 inThemeOrange">Mobile Verification</h2>
                        ...
                        <div class="gtSMSVerification col-xxl-10 col-xxl-offset-3">
                            ...
                            <div class="form-group mt-30">
                                <form action="<?php echo e(route('verify.mobile.otp')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                            ...
                            <div class="col-xs-16">
                                <form action="<?php echo e(route('request.otp.again')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="mobile" id="mobile"
                                        value="<?php echo e($data['mobile'] ?? 'NA'); ?>">
                                    <input type="hidden" name="email" id="email"
...
<?php echo $__env->make('layouts.frontend.main-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mmm\resources\views\frontend\users\mobile-verification.blade.php ENDPATH**/ ?>