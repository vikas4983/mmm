...
<li id="abcV<?php echo e($searchResult->id); ?>" class="gt-panel gt-panel-default gt-panel-default gt-main-profile ">
        ...
        <div class="row" bis_skin_checked="1">
            <div class="col-xxl-5 col-xl-5 col-xs-16 col-lg-5 gridFullWidth gt-main-name" bis_skin_checked="1">
                ...
                $isFriend = $friends->contains(function ($friend) use ($searchResult) {
                    return ($friend->sender_id === $searchResult->id || $friend->receiver_id === $searchResult->id) && $friend->is_friend === 1;
                });
                ?>
                ...
                <?php else: ?>
                <h4 class="gt-margin-top-0 gt-margin-bottom-0 inThemeOrange">
                    <i class="far fa-id-card" title="Visible to Friends Only" style="color: #3A7303"></i>
                    <?php echo e($prefix->name ?? 'NA'); ?>-<?php echo e($searchResult->matrimony_id ?? 'NA'); ?>
    ...
    <div class="gt-result-panel-body">
        <div class="row gt-padding-bottom-15" bis_skin_checked="1">
            <div class="col-xxl-2 col-xl-2 col-xs-16 col-lg-3 gridFullWidth " bis_skin_checked="1">
                <div>
                    ...
                    <a class="image-frame" data-toggle="modal" data-target="#photoModal<?php echo e($image->id); ?>">
                        <img src="<?php echo e(asset('storage/users/images/' . $image->name)); ?>" class="img-responsive gtFullWidth main-image" alt="User Image">
                    ...
                    <?php if (isset($component)) {
                        $__componentOriginal25f4e9139185c7d4f0f6ef75ce4177da = $component;
                    } ?>
                    <?php if (isset($attributes)) {
                        $__attributesOriginal25f4e9139185c7d4f0f6ef75ce4177da = $attributes;
                    } ?>
                    ...
                    <div class="image-frame">
                        <img src="<?php echo e($searchResult->gender === 'male' ? asset('storage/users/images/male-default.jpg') : asset('storage/users/images/female-default.jpg')); ?>" class="img-responsive gtFullWidth main-image" alt="User Image">
                    </div>
                    <?php endif; ?>
                    ...
                    <a class="image-frame blurred-image-frame">
                        <img src="<?php echo e(asset('storage/users/images/' . $image->name)); ?>" class="img-responsive gtFullWidth main-image blurred-image"
                            alt="User Image">
                        <div class="eye-icon viewPhotosModal">
                            <span
                                style="display: inline-block;background-color: #545C56;color: #fff;padding: 5px 10px;border-radius: 50px;font-size: 14px;font-weight: bold; text-align: center; min-width: 30px;">
                    ...
                    <a class="image-frame blurred-image-frame">
                        ...
                        <div class="center-text"><i class="fas fa-eye-slash" title="Photo Hide"></i></div>
                    </a>
                    <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
            ...
            <a href="<?php echo e(route('profile', $searchResult->uuid)); ?>" target="_blank"
                class="col-xxl-14 col-xl-14 col-xs-16 col-lg-13 gt-margin-top-10 gridFullWidth" bis_skin_checked="1">
                <div class="row" bis_skin_checked="1">
    ...
    <div class="gt-result-panel-footer" bis_skin_checked="1">
        <div class="row" bis_skin_checked="1">
            <div class="col-xxl-4 col-xl-4 col-lg-4 gt-margin-top-10 gridHidden interest-btn-container"
                ...
                <div id="send-interest<?php echo e($searchResult->id); ?>">
                    <a class="btn btn-default btn-block inResultSendMessageBtn friend-btn"
                        ...
                        <span class="hover-text cancel-interest-btn" data-id="<?php echo e($searchResult->id); ?>"
                            style="color: #dc3545;">
                ...
                <?php elseif(
                                $sender->receiver_id === $searchResult->id &&
                                    ...
                                    $sender->is_decline === 1): ?>
                <?php $invitationFound = true; ?>
                <div class="row" id="accept-by-me<?php echo e($searchResult->id); ?>" style="display: flex; margin-left: 35px;">
                ...
                <div id="friend<?php echo e($searchResult->id); ?>">
                    <a class="btn btn-default btn-block inResultSendMessageBtn friend-btn"
                        ...
                        <span class="hover-text decline-interest-by-me-btn" data-id="<?php echo e($searchResult->id); ?>"
                            style="color: #dc3545;">
                ...
                <?php $invitationFound = true; ?>
                <div class="row" id="accept-by-me<?php echo e($searchResult->id); ?>" style="display: flex; margin-left: 35px;">
                    <a class="btn btn-default inResultSendMessageBtn decline-btn " data-id="<?php echo e($searchResult->id); ?>">
                        <span
            ...
            <div id="block-user<?php echo e($searchResult->id); ?>" class="col-xxl-4 col-xl-4 col-lg-4 gt-margin-top-10 gridHidden"
                bis_skin_checked="1">
                <a data-id="<?php echo e($searchResult->id); ?>" class="btn btn-default btn-block inResultBlockBtn unBlock-btn">
            ...
            <div id="block-user<?php echo e($searchResult->id); ?>" class="col-xxl-4 col-xl-4 col-lg-4 gt-margin-top-10 gridHidden"
                bis_skin_checked="1">
                <a data-id="<?php echo e($searchResult->id); ?>" class="btn btn-default btn-block inResultBlockBtn block-btn">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php if (isset($component)) {
    $__componentOriginalb55be17bee5a7c18ce1be12c9593f430 = $component;
} ?>
<?php if (isset($attributes)) {
    $__attributesOriginalb55be17bee5a7c18ce1be12c9593f430 = $attributes;
} ?>
