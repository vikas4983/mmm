                                        ...
                                        <li class="d-flex flex-wrap align-items-start mb-3">
                                            ...
                                            <div class="col-xxl-4 col-xs-10 col-sm-10 col-md-8 col-lg-4"
                                                ...
                                                <a href="javascript:void(0);" data-toggle="modal"
                                                    data-target="#messageModal<?php echo e($user->id); ?>"><i
                                                        class="fa fa-envelope gt-margin-right-10 sendMessage"
                                                        style="margin-right: 10px;color:#FF7E00"></i></a>

                                                <a href="javascript:void(0);" data-toggle="modal"
                                                    data-target="#messageModal<?php echo e($user->id); ?>" title="Matri ID"
                                            ...
                                            <div class="col-xxl-8 col-xs-16 col-sm-16 col-md-16 col-lg-8 gt-margin-top-8">
                                                <a href="javascript:void(0);" data-toggle="modal"
                                                    data-target="#messageModal<?php echo e($user->id); ?>" title="Message">
                                            ...
                                            <div class="col-xxl-2 col-xs-16 col-sm-16 col-md-16 col-lg-2">
                                                <a href="javascript:void(0);" data-toggle="modal"
                                                    data-target="#messageModal<?php echo e($user->id); ?>" title="Date">
                                                    <h4 class="name2">
...
<?php $component = App\View\Components\UserActions\ShowMessageComponent::resolve(['user' => $user] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
