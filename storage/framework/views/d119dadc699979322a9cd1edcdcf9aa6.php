...
<form action="<?php echo e(route('settings.horoscope.update')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    ...
    <div class="mb-3">
        ...
        <div class="form-check mt-5">
            <input class="form-check-input" type="radio" name="horoscope_privacy" id="privacyAll" value="1"
                <?php echo e(old('horoscope_privacy', $settingData->horoscope) == 1 ? 'checked' : ''); ?>>
        ...
        <div class="form-check mt-5">
            <input class="form-check-input" type="radio" name="horoscope_privacy" id="privacyFriends" value="2"
                <?php echo e(old('horoscope_privacy', $settingData->horoscope) == 2 ? 'checked' : ''); ?>>
        ...
        <div class="form-check mt-5">
            <input class="form-check-input" type="radio" name="horoscope_privacy" id="privacyHidden" value="0"
                <?php echo e(old('horoscope_privacy', $settingData->horoscope) == 0 ? 'checked' : ''); ?>>
...
<?php /**PATH C:\xampp\htdocs\mmm\resources\views\components\settings\horoscope-setting-component.blade.php ENDPATH**/ ?>