                ...
                <div class="container" id="container"> <!-- Added ID for targeting -->
                    <div class="row">
                        ...
                        <div
                            ...
                            <form class="gt-login-form gtLogin" action="<?php echo e(route('login.otp')); ?>" method="post"
                                id="forgot_form">
...
<?php echo $__env->make('layouts.frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mmm\resources\views\frontend\users\loginWithOtp.blade.php ENDPATH**/ ?>