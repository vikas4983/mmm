<div id="accept-decline<?php echo e($receiverId); ?>" class="btn-group" role="group">
    <a title="Accept Interest" class="gt-cursor btn btn-default accept-interest-by-me-btn"
        data-id="<?php echo e($receiverId); ?>" style="width: 12.4rem">
    ...
    <a title="Cancel Interest" class="gt-cursor btn btn-default decline-interest-by-me-btn"
        data-id="<?php echo e($receiverId); ?>" style="width: 12.5rem">
        <i class="fas fa-times gt-margin-right-5" style="color:#A0061C;"></i>
        <p class="hidden-xs hidden-sm hidden-md">Decline</p>
    </a>
</div><?php /**PATH C:\xampp\htdocs\mmm\resources\views\userAction\buttons\profiles\acceptDeclineBtn.blade.php ENDPATH**/ ?>