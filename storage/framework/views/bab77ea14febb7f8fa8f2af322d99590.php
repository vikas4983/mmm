...
<?php $component = App\View\Components\QuickSearchComponent::resolve(['age' => $age,'options' => $options] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\Searches\BasicSearchComponent::resolve(['options' => $options] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-6">
                                                                <select class="gt-form-control flat" name="to_height"
                                                                    ...
                                                                    <option value="2" disabled>4ft 6in - 137cm
                                                                    </option>
                                                                    <option value="3" disabled>4ft 7in - 139cm
                                                                    </option>
                                                                    <option value="4" disabled>4ft 8in - 142cm
                                                                    </option>
                                                                    <option value="5" disabled>4ft 9in - 144cm
                                                                    </option>
                                                                    <option value="6" disabled>4ft 10in - 147cm
                                                                    </option>
                                                                    <option value="7" disabled>4ft 11in - 149cm
                                                                    </option>
                                                                    <option value="8" disabled>5ft - 152cm</option>
                                                                    <option value="9" disabled>5ft 1in - 154cm
                                                                    </option>
                                                                    <option value="10" disabled>5ft 2in - 157cm
                                                                    </option>
                                                                    <option value="11" disabled>5ft 3in - 160cm
                                                                    </option>
                                                                    <option value="12" disabled>5ft 4in - 162cm
                                                                    </option>
...
<?php echo $__env->make('layouts.frontend.main-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mmm\resources\views/frontend/search/quick.blade.php ENDPATH**/ ?>