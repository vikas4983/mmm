            ...
            <div class="col-xxl-16 col-xl-16 col-lg-16 col-md-16 col-sm-16 col-xs-16 pb-10 pt-10 gt-view-detail">
                <article>
                    <p id="userEducationDetails" class="gt-word-wrap">
                        <?php echo e($user->carrierDetails->education_detail); ?>
...
<?php /**PATH C:\xampp\htdocs\mmm\resources\views/components/view-education-details-component.blade.php ENDPATH**/ ?>