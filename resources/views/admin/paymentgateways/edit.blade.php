                    ...
                    <div class="col-lg-4">
                        <div class="card card-default">
                            <div class="card-body">
                                ...
                                @endif
                                <form action="{{ route('paymentgateways.update', 1) }}" method="post">
                                    @csrf
                                    @method('PATCH')
                                    <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card card-default">
                            <div class="card-body">
                                ...
                                @endif
                                <form action="{{ route('paymentgateways.update', 2) }}" method="post">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            ...
                                            <input type="text" class="form-control" name="merchant_key"
                                                placeholder="Enter Merchant Key " value="{{ old('merchant_key') }}">
                                        </div>
                                        <div class="form-group col-lg-12">
                                            <label>Salt</label>
                                            <input type="text" class="form-control" name="salt"
                                                placeholder="Enter Salt " value="{{ old('salt') }}">
                                        </div>
                                        <div class="form-group col-lg-12">
                                            <label>Merchant Id</label>
                                            <input type="text" class="form-control" name="merchant_id"
                                                placeholder="Enter Merchant Id " value="{{ old('merchant_id') }}">
                                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card card-default">
                            <div class="card-body">
                                ...
                                @endif
                                <form action="{{ route('paymentgateways.update', 3) }}" method="post">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-12">
                                            ...
                                            <input type="text" class="form-control" name="bank_ifsc"
                                                placeholder="Enter Bank IFSC Code " value="{{ old('bank_ifsc') }}">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label>Account Type</label>
                                            <input type="text" class="form-control" name="bank_account_type"
                                                placeholder="Enter Account Type " value="{{ old('bank_account_type') }}">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label>Status</label>
                                            <select name="status" class="form-control">
