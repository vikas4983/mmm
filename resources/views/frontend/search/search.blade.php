...
@section('title', 'Search - Mangal Mandap')
@section('content')
                            ...
                            <div role="tabpanel" class="tab-pane active" id="quick-search">
                                <div class="row">
                                    @php
                                        ...
                                        $options[] = '';
                                    @endphp
                                    <x-quick-search-component :age="$age" :options="$options" :quickFilter="$quickFilter" />
                                </div>
                            </div>
                            <!-- Basic Search  -->
                            <div role="tabpanel" class="tab-pane " id="basic-search">
                                <div class="row">
                                    <x-searches.basic-search-component :options="$options" :basicFilter="$basicFilter" />
                                </div>
                            </div>
                            <!-- Advance Search  -->
                            <div role="tabpanel" class="tab-pane " id="advance-search">
                                <div class="row">
                                    <x-searches.advance-search-component :options="$options" :selectedAdvanceFilters="$selectedAdvanceFilters" />
