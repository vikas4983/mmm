...
@section('title', 'Messages-Sent - Mangal Mandap')
@section('content')
<div class="container">
    					<div class="row">
...
<!-- /.Analytic Code -->
    		...
    		<script>
	  		...
	  		<script src="{{asset('assets/js/listpagination_search/list.js')}}"></script>
			<script src="{{asset('assets/js/listpagination_search/list.pagination.js')}}"></script> 
			<script type="text/javascript">
