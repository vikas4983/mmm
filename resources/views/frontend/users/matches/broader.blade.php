...
@section('title', 'Broders Matches - Mangal Mandap')
@section('content')
    <div class="container">
        <div class="row">
            <aside class="col-xxl-4 col-xl-4 col-xs-16">
                ...
                <div class="collapse mobile-collapse" id="collapseExample">
                    <ul class="my-match-aside mb-20 col-xs-16">
                        <li>
                            <a href="{{url('one-way-matches')}}"><i class="fas fa-long-arrow-alt-right gt-margin-right-10"></i>One Way
                                Matches</a>
                        </li>
                        <li>
                            <a href="{{url('two-way-matches')}}"><i class="fas fa-exchange-alt gt-margin-right-10"></i>Two Way
                                Matches</a>
                        </li>
                        <li>
                            <a href="{{url('preferred-matches')}}"><i class="fas fa-star gt-margin-right-10"></i>Preferred Matches</a>
                        </li>
                        <li>
                            <a href="{{url('broader-matches')}}"><i class="fa fa-arrows-alt gt-margin-right-10"></i>Broader Matches</a>
                        </li>
                        <li>
                            <a href="{{url('custom-matches')}}"><i class="fa fa-tasks gt-margin-right-10"></i>Custom Matches</a>
                        </li>
                    </ul>
                </div>
            </aside>
