                    ...
                    <label for="gt-plan-28" class="col-xxl-4 col-xl-4 col-xs-16 col-lg-8">
                        <div class="gt-plan" id="setselected28">
                            ...
                            <a class="btn btn-primary gtMobPlan visible-xs visible-sm visible-md" role="button"
                                data-toggle="collapse" href="#collapsePlan28" aria-expanded="false"
                                aria-controls="collapsePlan28">
                    ...
                    <label for="gt-plan-29" class="col-xxl-4 col-xl-4 col-xs-16 col-lg-8">
                        <div class="gt-plan" id="setselected29">
                            <div class="gt-plan-header">
                                <h1><i class="fa fa-certificate"></i></h1>
                                <h4>
                                    <input type="radio" id="gt-plan-29" name="plan" onChange="getselected('29');"
                                        class="Table_Details inDisplayNone">
                                    <span id="planname29">
                                        MM-GOLD </span>
                                </h4>
                            ...
                            <!-- Plan display for mobile -->
                            <a class="btn btn-primary gtMobPlan visible-xs visible-sm visible-md" role="button"
                                data-toggle="collapse" href="#collapsePlan29" aria-expanded="false"
                                aria-controls="collapsePlan29">
                                View Plan Detail <div class="clearfix"></div>
                                <i class="fa fa-chevron-down"></i>
                            </a>
                    ...
                    <label for="gt-plan-30" class="col-xxl-4 col-xl-4 col-xs-16 col-lg-8">
                        <div class="gt-plan" id="setselected30">
                            <div class="gt-plan-header">
                                <h1><i class="fa fa-certificate"></i></h1>
                                <h4>
                                    <input type="radio" id="gt-plan-30" name="plan" onChange="getselected('30');"
                                        class="Table_Details inDisplayNone">
                                    <span id="planname30">
                                        MM-SILVER </span>
                                </h4>
                            ...
                            <!-- Plan display for mobile -->
                            <a class="btn btn-primary gtMobPlan visible-xs visible-sm visible-md" role="button"
                                data-toggle="collapse" href="#collapsePlan30" aria-expanded="false"
                                aria-controls="collapsePlan30">
                                View Plan Detail <div class="clearfix"></div>
                                <i class="fa fa-chevron-down"></i>
                            </a>
                    ...
                    <label for="gt-plan-32" class="col-xxl-4 col-xl-4 col-xs-16 col-lg-8">
                        <div class="gt-plan" id="setselected32">
                            <div class="gt-plan-header">
                                <h1><i class="fa fa-certificate"></i></h1>
                                <h4>
                                    <input type="radio" id="gt-plan-32" name="plan" onChange="getselected('32');"
                                        class="Table_Details inDisplayNone">
                                    <span id="planname32">
                            ...
                            <!-- Plan display for mobile -->
                            <a class="btn btn-primary gtMobPlan visible-xs visible-sm visible-md" role="button"
                                data-toggle="collapse" href="#collapsePlan32" aria-expanded="false"
                                aria-controls="collapsePlan32">
                                View Plan Detail <div class="clearfix"></div>
                                <i class="fa fa-chevron-down"></i>
                            </a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-8">
                                        <h4 class="gt-margin-top-30">
                                            Total Amount :-
                                            <span class="gt-margin-left-10 gt-text-green"
                                                id="dis_plan_amount">Rs.1000</span>
                                        </h4>
                                    </div>
                                </div>
