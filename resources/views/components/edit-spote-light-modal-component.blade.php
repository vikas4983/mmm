<div class="modal fade" id="exampleModal-editSpoteLight{{ $paidUser->user->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('spotelights.update', $paidUser->user->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('Patch')
