            ...
            <div
                ...
                <article>
                    ...
                    <div class="col-xxl-16 col-xl-16 col-lg-16 col-md-16 col-sm-16 col-xs-16 pt-10 pb-10 gt-view-detail"
                        ...
                        <form id="aboutMeForm" action="{{ route('about.me.update') }}" method="POST">
                            @csrf <!-- Include CSRF token -->
                            @method('PATCH')
                            <textarea type="text" class="gt-form-control" rows="5" id="about_me" name="about_me" required>{{ $user->carrierDetails->about_me }}</textarea>
                        </form>
                    </div>
                    </p>
                </article>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        updateAboutMe.addEventListener("click", function(event) {
            ...
            // let url = "{{ route('about.me.update') }}"; // Server endpoint (make sure it's correct)
