                ...
                <article>
                    ...
                    <div class="col-xxl-16 col-xl-16 col-lg-16 col-md-16 col-sm-16 col-xs-16 pt-10 pb-10 gt-view-detail"
                        ...
                        <form id="aboutFamilyForm" method="POST">
                            @csrf
                            @method('PATCH')
                            <textarea type="text" class="gt-form-control" rows="5" id="about_family" name="about_family" required>{{ $user->familyDetails->about_family }}</textarea>
                        </form>
                    </div>
                    </p>
                </article>
