                ...
                <article>
                    ...
                    <div class="col-xxl-16 col-xl-16 col-lg-16 col-md-16 col-sm-16 col-xs-16 pt-10 pb-10 gt-view-detail"
                        ...
                        <form id="aboutOccupationForm" method="POST">
                            @csrf
                            @method('PATCH')
                            <textarea type="text" class="gt-form-control" rows="5" id="occupation_detail" name="occupation_detail" required>{{ $user->carrierDetails->education_detail }}</textarea>
                        </form>
                    </div>
                    </p>
                </article>
