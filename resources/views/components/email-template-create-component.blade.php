              ...
              <form action="{{ route('emailTemplates.store') }}" method="post">
                ...
                <div class="row">
                  <div class="form-group col-lg-3">
                    <label>Name</label>
                    <input type="text" class="form-control" name="name" placeholder="Enter Email Template Name" value="{{ old('name') }}" required>
                  </div>
                  <div class="form-group col-lg-3">
                    <label>Subject</label>
                  ...
                  <div class="form-group col-lg-3">
                    ...
                    <select name="action" class="form-control">
                      <option value="1" {{ old('action') === '1' ? 'selected' : '' }}>Admin</option>
                      <option value="0" {{ old('action') === '0' ? 'selected' : '' }}>User</option>
                    </select>
                  </div>
